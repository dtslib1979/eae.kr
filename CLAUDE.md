...
```
전역 테마: PARKSY CHALKBOARD (다크 그린 칠판)
배경: #253A2F (parksy-chalk-base)
텍스트: 밝은 색 (slate-50 ~ slate-300)

⚠️ 모든 컴포넌트는 다크 테마 기준!
밝은 배경(white, gray-50, amber-50 등) 사용 금지
```
...
| 컴포넌트 | 배경 | 악센트 |
|---------|------|--------|
| Part1 | `amber-950/40` | `amber-400/500` |
| Part2 | `blue-950/40` | `blue-400/500` |
| Part3 | `purple-950/40` | `purple-400/500` |

```
prose-invert 필수 사용
텍스트: slate-200 (본문), slate-100 (제목)
절대 밝은 배경 + 어두운 텍스트 조합 금지
```

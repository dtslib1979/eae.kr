...
<Accordion>
  ...
  <AccordionItem title="1. System Overview">
    Skillset6 is a creative thinking framework processed through three core stages:
    
    1. **Feed** – 정보 수집 (Information Collection)
    2. **Digest** – 구조화 (Structuring)
    3. **Expression** – 표현 (Expression)
    
    Each stage transforms input into structured creative output.
  </AccordionItem>

  <AccordionItem title="2. Workflow / Data Flow">
    ```
    ...
    The system takes raw input, processes it through the Digest stage, and produces creative expression as output.
  </AccordionItem>

export default function SketchCard({ src, caption, children, title = "Sketch" }) {
  return (
    <div className="sketch-card my-8 p-6 bg-white rounded-xl border-2 border-dashed border-gray-300 shadow-lg">
      ...
      <div className="sketch-content bg-gray-50 p-4 rounded-lg min-h-[200px] flex flex-col items-center justify-center">
        {src ? (
